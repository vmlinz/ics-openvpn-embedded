...
public class OpenVPNThread implements Runnable {
	...
	public void run() {
		try {
			...
			VpnStatus.updateStateString("NOPROCESS", "No process running.", R.string.openvpn_state_noprocess, ConnectionStatus.LEVEL_NOTCONNECTED);
			if(mDumpPath!=null) {
				try {
					...
					logout.close();
					VpnStatus.logError(R.string.openvpn_minidump_generated);
				} catch (IOException e) {
