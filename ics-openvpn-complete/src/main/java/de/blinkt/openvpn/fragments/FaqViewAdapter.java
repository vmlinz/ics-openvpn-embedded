...
public class FaqViewAdapter extends RecyclerView.Adapter<FaqViewAdapter.FaqViewHolder> {
    ...
    private void fetchStrings(FaqFragment.FAQEntry[] faqItems) {
        for (int i =0; i < faqItems.length; i++) {
            ...
            // Add hack R.string.openvpn_faq_system_dialogs_title -> R.string.openvpn_faq_system_dialog_xposed
            if (faqItems[i].title == R.string.openvpn_faq_system_dialogs_title)
            {
                Spanned xPosedtext = Html.fromHtml(textColor + mContext.getString(R.string.openvpn_faq_system_dialog_xposed));
    ...
    public static class FaqViewHolder extends RecyclerView.ViewHolder {
        ...
        public FaqViewHolder(View itemView) {
            ...
            mBody = (TextView)mView.findViewById(R.id.openvpn_faq_body);
            mHead = (TextView)mView.findViewById(R.id.openvpn_faq_head);
    ...
    public FaqViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.openvpn_faqcard, viewGroup, false);
