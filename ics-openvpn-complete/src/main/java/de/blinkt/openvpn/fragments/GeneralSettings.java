...
public class GeneralSettings extends PreferenceFragment implements OnPreferenceClickListener, OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		addPreferencesFromResource(R.xml.openvpn_general_settings);
	...
	private void setClearApiSummary() {
		...
		if(mExtapp.getExtAppList().isEmpty()) {
			...
			clearapi.setSummary(R.string.openvpn_no_external_app_allowed);
		} else { 
			clearapi.setEnabled(true);
			clearapi.setSummary(getString(R.string.openvpn_allowed_apps,getExtAppList(", ")));
		}
	}
	...
	public boolean onPreferenceClick(Preference preference) { 
		if(preference.getKey().equals("clearapi")){
			...
			builder.setPositiveButton(R.string.openvpn_clear, this);
			builder.setNegativeButton(android.R.string.cancel, null);
			builder.setMessage(getString(R.string.openvpn_clearappsdialog,getExtAppList("\n")));
			builder.show();
		}
