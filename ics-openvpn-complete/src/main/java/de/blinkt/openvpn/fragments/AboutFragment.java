...
public class AboutFragment extends Fragment implements View.OnClickListener {
    ...
    private void createPlayBuyOptions(ArrayList<String> ownedSkus, ArrayList<String> responseList) {
        try {
            ...
            gdonation.add(new Pair<String, String>(getString(R.string.openvpn_donatePlayStore),null));
    ...
    private Pair<String,String> getSkuTitle(final String sku, String title, String price, ArrayList<String> ownedSkus) {
        ...
        if (ownedSkus.contains(sku))
            return new Pair<String,String>(getString(R.string.openvpn_thanks_for_donation, price),null);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.openvpn_about, container, false);
        TextView ver = (TextView) v.findViewById(R.id.openvpn_version);
        ...
        try {
            ...
            name = getString(R.string.openvpn_app);
        } catch (NameNotFoundException e) {
            version = "error fetching version";
        }


        ver.setText(getString(R.string.openvpn_version_info, name, version));

        TextView paypal = (TextView) v.findViewById(R.id.openvpn_donatestring);

        String donatetext = getActivity().getString(R.string.openvpn_donatewithpaypal);
        Spanned htmltext = Html.fromHtml(donatetext);
        paypal.setText(htmltext);
        paypal.setMovementMethod(LinkMovementMethod.getInstance());
        gmsTextView = (TextView) v.findViewById(R.id.openvpn_donategms);
        ...
        TextView translation = (TextView) v.findViewById(R.id.openvpn_translation);

        // Don't print a text for myself
        if (getString(R.string.openvpn_translationby).contains("Arne Schwabe"))
            translation.setText("");
        else
            translation.setText(R.string.openvpn_translationby);

        WebView wv = (WebView)v.findViewById(R.id.openvpn_webView);
