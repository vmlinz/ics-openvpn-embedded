...
public class ShowConfigFragment extends Fragment {
	...
	{
		View v=inflater.inflate(R.layout.openvpn_viewconfig, container,false);
		mConfigView = (TextView) v.findViewById(R.id.openvpn_configview);
		

        ImageButton fabButton = (ImageButton) v.findViewById(R.id.openvpn_share_config);
        if (fabButton!=null)
	...
	public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP)
		    inflater.inflate(R.menu.openvpn_configmenu, menu);
	}
	
	private void shareConfig() {
		Intent shareIntent = new Intent(Intent.ACTION_SEND);
		shareIntent.putExtra(Intent.EXTRA_TEXT, configtext);
		shareIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.openvpn_export_config_title));
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (itemId == R.id.openvpn_sendConfig) {
			shareConfig();
			return true;
		} else {
    ...
    public void onResume() {
        ...
        if(check!=R.string.openvpn_no_error_found) {
