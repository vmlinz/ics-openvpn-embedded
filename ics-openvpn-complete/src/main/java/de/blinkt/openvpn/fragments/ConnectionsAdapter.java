...
public class ConnectionsAdapter extends RecyclerView.Adapter<ConnectionsAdapter.ConnectionsHolder>  {
    ...
    public static class ConnectionsHolder extends RecyclerView.ViewHolder {
        ...
        public ConnectionsHolder(View card) {
            super(card);
            mServerNameView = (EditText) card.findViewById(R.id.openvpn_servername);
            mPortNumberView = (EditText) card.findViewById(R.id.openvpn_portnumber);
            mRemoteSwitch = (Switch) card.findViewById (R.id.openvpn_remoteSwitch);
            mCustomOptionCB = (CheckBox) card.findViewById(R.id.openvpn_use_customoptions);
            mCustomOptionText = (EditText) card.findViewById(R.id.openvpn_customoptions);
            mProtoGroup = (RadioGroup) card.findViewById(R.id.openvpn_udptcpradiogroup);
            mCustomOptionsLayout = card.findViewById(R.id.openvpn_custom_options_layout);
            mDeleteButton = (ImageButton) card.findViewById(R.id.openvpn_remove_connection);
    ...
    public ConnectionsAdapter.ConnectionsHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View card = li.inflate(R.layout.openvpn_server_card, viewGroup, false);
    ...
    public void onBindViewHolder(final ConnectionsAdapter.ConnectionsHolder cH, final int i) {
        ...
        cH.mProtoGroup.check(connection.mUseUdp ? R.id.openvpn_udp_proto : R.id.openvpn_tcp_proto);
        cH.mProtoGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.openvpn_udp_proto)
                    connection.mUseUdp=true;
                else if (checkedId == R.id.openvpn_tcp_proto)
        ...
        cH.mDeleteButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        ab.setTitle(R.string.openvpn_query_delete_remote);
                        ab.setPositiveButton(R.string.openvpn_keep, null);
                        ab.setNegativeButton(R.string.openvpn_delete, new DialogInterface.OnClickListener() {
                            @Override
