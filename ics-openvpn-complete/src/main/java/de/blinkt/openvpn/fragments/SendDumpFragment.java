...
public class SendDumpFragment extends Fragment  {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View v = inflater.inflate(R.layout.openvpn_fragment_senddump, container, false);
		v.findViewById(R.id.openvpn_senddump).setOnClickListener(new OnClickListener() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				getActivity().runOnUiThread(new Runnable() {
					@Override
					public void run() {
						TextView dumpDateText = (TextView) v.findViewById(R.id.openvpn_dumpdate);
						...
						dumpDateText.setText(getString(R.string.openvpn_lastdumpdate, hours, minutes, datestr));
