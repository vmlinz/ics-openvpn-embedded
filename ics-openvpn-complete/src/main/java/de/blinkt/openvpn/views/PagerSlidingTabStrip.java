...
public class PagerSlidingTabStrip extends HorizontalScrollView implements TabBarView {
    ...
    private int tabBackgroundResId = R.drawable.openvpn_slidingtab_background;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        // get custom attrs
        a = context.obtainStyledAttributes(attrs, R.styleable.openvpn_PagerSlidingTabStrip);
        indicatorColor = a.getColor(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsIndicatorColor, indicatorColor);
        underlineColor = a.getColor(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsUnderlineColor, underlineColor);
        dividerColor = a.getColor(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsDividerColor, dividerColor);
        dividerWidth = a.getDimensionPixelSize(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsDividerWidth, dividerWidth);
        indicatorHeight = a.getDimensionPixelSize(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsIndicatorHeight, indicatorHeight);
        underlineHeight = a.getDimensionPixelSize(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsUnderlineHeight, underlineHeight);
        dividerPadding = a.getDimensionPixelSize(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsDividerPadding, dividerPadding);
        tabPadding = a.getDimensionPixelSize(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsTabPaddingLeftRight, tabPadding);
        tabBackgroundResId = a.getResourceId(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsTabBackground, tabBackgroundResId);
        shouldExpand = a.getBoolean(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsShouldExpand, shouldExpand);
        scrollOffset = a.getDimensionPixelSize(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsScrollOffset, scrollOffset);
        textAllCaps = a.getBoolean(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsTextAllCaps, textAllCaps);
        isPaddingMiddle = a.getBoolean(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsPaddingMiddle, isPaddingMiddle);
        tabTypefaceStyle = a.getInt(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsTextStyle, Typeface.BOLD);
        tabTypefaceSelectedStyle = a.getInt(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsTextSelectedStyle, Typeface.BOLD);
        tabTextAlpha = a.getFloat(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsTextAlpha, HALF_TRANSP);
        tabTextSelectedAlpha = a.getFloat(R.styleable.openvpn_PagerSlidingTabStrip_openvpn_pstsTextSelectedAlpha, OPAQUE);
        a.recycle();
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof CustomTabProvider) {
                ...
                tabView = LayoutInflater.from(getContext()).inflate(R.layout.openvpn_padersliding_tab, this, false);
            }
    ...
    private void addTab(final int position, CharSequence title, View tabView) {
        TextView textView = (TextView) tabView.findViewById(R.id.openvpn_tab_title);
        if (textView != null) {
    ...
    private void updateTabStyles() {
        for (int i = 0; i < tabCount; i++) {
            ...
            TextView tab_title = (TextView) v.findViewById(R.id.openvpn_tab_title);
    ...
    private void notSelected(View tab) {
        TextView title = (TextView) tab.findViewById(R.id.openvpn_tab_title);
        if (title != null) {
